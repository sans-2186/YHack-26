...
from app.scoring.political_tags import political_weighted_hits
...
def score_bias_risk(items: list[dict[str, Any]]) -> ComponentScore:
...
def score_political_risk(items: list[dict[str, Any]]) -> ComponentScore:
